...
namespace player
{
  ...
  public partial class GetAllPlayerResp : global::ProtoBuf.IExtensible
  {
    ...
    private readonly global::System.Collections.Generic.List<player.PlayerProtoData> _players = new global::System.Collections.Generic.List<player.PlayerProtoData>();
    [global::ProtoBuf.ProtoMember(2, Name=@"players", DataFormat = global::ProtoBuf.DataFormat.Default)]
    public global::System.Collections.Generic.List<player.PlayerProtoData> players
    {
      get { return _players; }
    }
