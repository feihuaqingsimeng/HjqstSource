...
public class SM_prefabGenerator : MonoBehaviour
{
    ...
    public int layer = (int)LayerType.Fight;
    ...
    void Update()
    {
        ...
        if (timeCounter > trigger && effectCounter <= thisManyTimes)
        {
            ...
            GameObject justCreated = Instantiate(createThis[(int)rndNr], new Vector3(x_cur, y_cur, z_cur), transform.rotation) as GameObject;  //create the prefab
            ...
            Common.Util.TransformUtil.SwitchLayer(justCreated.transform, layer);
