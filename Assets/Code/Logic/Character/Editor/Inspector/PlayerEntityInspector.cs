...
{
    [CustomEditor(typeof(Logic.Character.PlayerEntity))]
    public class PlayerEntityInspector : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                Logic.Player.Model.PlayerInfo playerInfo = Game.Model.GameProxy.instance.PlayerInfo;
                if (playerInfo != null)
                {
                    EditorGUILayout.LabelField("level:", playerInfo.level.ToString());
                    EditorGUILayout.LabelField("exp:", playerInfo.exp.ToString());
                    EditorGUILayout.LabelField("totalExp:", playerInfo.TotalLevelUpExp.ToString());
                }
