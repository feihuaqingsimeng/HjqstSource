...
namespace Logic.Protocol.Model
{
  ...
  public partial class SendNoticeReq : global::ProtoBuf.IExtensible
  {
    ...
    private readonly global::System.Collections.Generic.List<Logic.Protocol.Model.NoticeInfo> _noticeInfos = new global::System.Collections.Generic.List<Logic.Protocol.Model.NoticeInfo>();
    [global::ProtoBuf.ProtoMember(1, Name=@"noticeInfos", DataFormat = global::ProtoBuf.DataFormat.Default)]
    public global::System.Collections.Generic.List<Logic.Protocol.Model.NoticeInfo> noticeInfos
    {
