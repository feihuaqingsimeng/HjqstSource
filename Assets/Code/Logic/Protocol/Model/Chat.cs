...
namespace Logic.Protocol.Model
{
  ...
  public partial class ChatInfoResp : global::ProtoBuf.IExtensible
  {
    ...
    private readonly global::System.Collections.Generic.List<Logic.Protocol.Model.ChatProtoData> _chatList = new global::System.Collections.Generic.List<Logic.Protocol.Model.ChatProtoData>();
    [global::ProtoBuf.ProtoMember(1, Name=@"chatList", DataFormat = global::ProtoBuf.DataFormat.Default)]
    public global::System.Collections.Generic.List<Logic.Protocol.Model.ChatProtoData> chatList
    {
