...
public class LTDescrWrap
{
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			LTDescr obj = (LTDescr)ToLua.CheckObject(L, 1, typeof(LTDescr));
	...
	static int setEase(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(UnityEngine.AnimationCurve)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
				UnityEngine.AnimationCurve arg0 = (UnityEngine.AnimationCurve)ToLua.ToObject(L, 2);
				LTDescr o = obj.setEase(arg0);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(LeanTweenType)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
	...
	static int setFrom(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(float)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(UnityEngine.Vector3)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				LTDescr o = obj.setFrom(arg0);
	...
	static int setLoopClamp(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, typeof(LTDescr)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(int)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
	...
	static int setOnComplete(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action<object>)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action<object>), typeof(object)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
				System.Action<object> arg0 = null;
				LuaTypes funcType2 = LuaDLL.lua_type(L, 2);
	...
	static int setOnUpdate(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action<UnityEngine.Color>)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action<float>)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action<UnityEngine.Vector2>), typeof(object)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action<UnityEngine.Vector3>), typeof(object)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action<float,object>), typeof(object)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(System.Action<UnityEngine.Vector3,object>), typeof(object)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
	...
	static int setRect(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(UnityEngine.RectTransform)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(UnityEngine.Rect)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(LTDescr), typeof(LTRect)))
			{
				LTDescr obj = (LTDescr)ToLua.ToObject(L, 1);
