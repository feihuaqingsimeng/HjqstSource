...
public class UnityEngine_UI_ShadowWrap
{
	...
	static int ModifyMesh(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.UI.Shadow), typeof(UnityEngine.Mesh)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.UI.Shadow), typeof(UnityEngine.UI.VertexHelper)))
			{
				UnityEngine.UI.Shadow obj = (UnityEngine.UI.Shadow)ToLua.ToObject(L, 1);
