...
public class UnityEngine_AudioSourceWrap
{
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, typeof(UnityEngine.AudioSource)))
			{
				UnityEngine.AudioSource obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
				obj.Play();
				return 0;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.AudioSource), typeof(ulong)))
			{
				UnityEngine.AudioSource obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
	...
	static int PlayOneShot(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.AudioSource), typeof(UnityEngine.AudioClip)))
			{
				UnityEngine.AudioSource obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.AudioSource), typeof(UnityEngine.AudioClip), typeof(float)))
			{
				UnityEngine.AudioSource obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
				UnityEngine.AudioClip arg0 = (UnityEngine.AudioClip)ToLua.ToObject(L, 2);
	...
	static int PlayClipAtPoint(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.AudioClip), typeof(UnityEngine.Vector3)))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.AudioClip), typeof(UnityEngine.Vector3), typeof(float)))
			{
				UnityEngine.AudioClip arg0 = (UnityEngine.AudioClip)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 2);
