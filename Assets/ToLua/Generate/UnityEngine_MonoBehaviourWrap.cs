...
public class UnityEngine_MonoBehaviourWrap
{
	...
	static int CancelInvoke(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, typeof(UnityEngine.MonoBehaviour)))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
				obj.CancelInvoke();
				return 0;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.MonoBehaviour), typeof(string)))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
	...
	static int StartCoroutine(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.MonoBehaviour), typeof(string)))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.MonoBehaviour), typeof(System.Collections.IEnumerator)))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.MonoBehaviour), typeof(string), typeof(object)))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
	...
	static int StopCoroutine(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.MonoBehaviour), typeof(UnityEngine.Coroutine)))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
