...
public class UnityEngine_CameraWrap
{
	...
	static int SetTargetBuffers(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Camera), typeof(UnityEngine.RenderBuffer[]), typeof(UnityEngine.RenderBuffer)))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Camera), typeof(UnityEngine.RenderBuffer), typeof(UnityEngine.RenderBuffer)))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
	...
	static int RenderToCubemap(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Camera), typeof(UnityEngine.RenderTexture)))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Camera), typeof(UnityEngine.Cubemap)))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Camera), typeof(UnityEngine.RenderTexture), typeof(int)))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
				UnityEngine.RenderTexture arg0 = (UnityEngine.RenderTexture)ToLua.ToObject(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Camera), typeof(UnityEngine.Cubemap), typeof(int)))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
				UnityEngine.Cubemap arg0 = (UnityEngine.Cubemap)ToLua.ToObject(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
