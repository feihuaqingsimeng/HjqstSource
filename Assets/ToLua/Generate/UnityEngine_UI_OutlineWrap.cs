...
public class UnityEngine_UI_OutlineWrap
{
	...
	static int ModifyMesh(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.UI.Outline), typeof(UnityEngine.Mesh)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.UI.Outline), typeof(UnityEngine.UI.VertexHelper)))
			{
				UnityEngine.UI.Outline obj = (UnityEngine.UI.Outline)ToLua.ToObject(L, 1);
