...
public class UnityEngine_RectWrap
{
	...
	static int _CreateUnityEngine_Rect(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Vector2), typeof(UnityEngine.Vector2)))
			{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, typeof(float), typeof(float), typeof(float), typeof(float)))
			{
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Rect)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Rect), typeof(string)))
			{
				UnityEngine.Rect obj = (UnityEngine.Rect)ToLua.ToObject(L, 1);
	...
	static int Contains(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Rect), typeof(UnityEngine.Vector3)))
			{
				UnityEngine.Rect obj = (UnityEngine.Rect)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Rect), typeof(UnityEngine.Vector2)))
			{
				UnityEngine.Rect obj = (UnityEngine.Rect)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Rect), typeof(UnityEngine.Vector3), typeof(bool)))
			{
				UnityEngine.Rect obj = (UnityEngine.Rect)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
	...
	static int Overlaps(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Rect), typeof(UnityEngine.Rect)))
			{
				UnityEngine.Rect obj = (UnityEngine.Rect)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, typeof(UnityEngine.Rect), typeof(UnityEngine.Rect), typeof(bool)))
			{
				UnityEngine.Rect obj = (UnityEngine.Rect)ToLua.ToObject(L, 1);
				UnityEngine.Rect arg0 = (UnityEngine.Rect)ToLua.ToObject(L, 2);
				bool arg1 = LuaDLL.lua_toboolean(L, 3);
