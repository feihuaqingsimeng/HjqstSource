...
public class UnityEngine_UI_BaseMeshEffectWrap
{
	...
	static int ModifyMesh(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.UI.BaseMeshEffect), typeof(UnityEngine.UI.VertexHelper)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(UnityEngine.UI.BaseMeshEffect), typeof(UnityEngine.Mesh)))
			{
				UnityEngine.UI.BaseMeshEffect obj = (UnityEngine.UI.BaseMeshEffect)ToLua.ToObject(L, 1);
