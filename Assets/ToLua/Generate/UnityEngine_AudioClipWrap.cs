...
public class UnityEngine_AudioClipWrap
{
	...
	static int Create(IntPtr L)
	{
		try
		{
			...
			if (count == 5 && TypeChecker.CheckTypes(L, typeof(string), typeof(int), typeof(int), typeof(int), typeof(bool)))
			{
			...
			else if (count == 6 && TypeChecker.CheckTypes(L, typeof(string), typeof(int), typeof(int), typeof(int), typeof(bool), typeof(UnityEngine.AudioClip.PCMReaderCallback)))
			{
				string arg0 = ToLua.ToString(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 7 && TypeChecker.CheckTypes(L, typeof(string), typeof(int), typeof(int), typeof(int), typeof(bool), typeof(UnityEngine.AudioClip.PCMReaderCallback), typeof(UnityEngine.AudioClip.PCMSetPositionCallback)))
			{
				string arg0 = ToLua.ToString(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 3);
