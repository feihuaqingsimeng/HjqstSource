...
public class UnityEngine_PlayerPrefsWrap
{
	...
	static int GetInt(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(string), typeof(int)))
			{
				string arg0 = ToLua.ToString(L, 1);
	...
	static int GetFloat(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(string), typeof(float)))
			{
				string arg0 = ToLua.ToString(L, 1);
	...
	static int GetString(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, typeof(string), typeof(string)))
			{
				string arg0 = ToLua.ToString(L, 1);
