local t={}
t.__index = t
local name='activity_generalwelfare_item'
...
function t:Init(info)
  ...
  self._TextlevelValue.text = string.format(LocalizationController.instance:Get("event_1011_generalWelfareValue"),  tonumber(itemData.event_param))
  self:InitAwards()
  self:InitButtons()
