...
function t.New(transform)
  ...
  if nil == o.transform then 
    ...
    o._TextlevelValue = o.transform:FindChild('lv/Text'):GetComponent(typeof(Text))
    o._TextPrice = o.transform:FindChild('price'):GetComponent(typeof(Text))
...
function t:Init(info)
  ...
  local strPrice = string.split(itemData.event_buymoney, ":")
  
  self._TextlevelValue.text = itemData.event_param
...
function t:InitButtons()
  ...
  elseif state == 2 then 
      ...
      ui_util.SetGrayChildren(self._BtnAward.transform, true, true)
  elseif state == 3 then 
      self._BtnAwardText.text = LocalizationController.instance:Get('event_1007_buy_btn3')
      ui_util.SetGrayChildren(self._BtnAward.transform, true, true)
  end
