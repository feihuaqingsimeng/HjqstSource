local t={}
t.__index = t
local name='activity_consume_item'
...
function t.New(transform)
  ...
  if nil == o.transform then 
    ...
    o._TextName = o.transform:FindChild('descText'):GetComponent(typeof(Text))
    o._TextlevelValue = o.transform:FindChild('descText/Text'):GetComponent(typeof(Text))
...
function t:Init(info)
  ...
  self._TextName.text = LocalizationController.instance:Get("event_1002_TextName")
  self._TextlevelValue.text = string.format(LocalizationController.instance:Get("event_1002_value"),
...
function t:InitButtons()
  ...
  elseif state == 2 then 
      ...
      ui_util.SetGrayChildren(self._BtnAward.transform, true, true)
  elseif state == 3 then 
      self._BtnAwardText.text = LocalizationController.instance:Get('event_public_btn3')
      ui_util.SetGrayChildren(self._BtnAward.transform, true, true)
  end
