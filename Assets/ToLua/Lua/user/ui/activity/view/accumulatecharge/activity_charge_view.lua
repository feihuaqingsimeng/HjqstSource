...
local name = 'activity_charge_view'
...
local activity_charge_item = require("ui/activity/view/accumulatecharge/activity_charge_item")
...
function t:OnItemInit(go, index)
  ...
  if nil == itemdata then do return end end
   ...
   if self.m_aryScrollItem[go] == nil then
      self.m_aryScrollItem[go]= activity_charge_item.New(go.transform)
