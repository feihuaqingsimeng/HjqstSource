local t={}
t.__index = t
local name='activity_charge_item'
...
function t:Init(info)
  ...
  self._TextName.text = LocalizationController.instance:Get("event_1001_TextName")
  self._TextlevelValue.text = string.format(LocalizationController.instance:Get("event_1001_value"),
...
function t:InitButtons()
  ...
  elseif state == 3 then 
      ...
      self._BtnAwardText.text = LocalizationController.instance:Get('event_1001_btn1')
      ui_util.SetGrayChildren(self._BtnAward.transform, false, true)
  end
